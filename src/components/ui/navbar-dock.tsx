import {
  ...
  export function NavbarDock() {
    return (
      <div className='absolute top-0 left-1/2 max-w-full -translate-x-1/2 mt-12'>
        <Dock className='items-end pb-3 py-4'>
          {data.map((item, idx) => (
            <DockItem
              key={idx}
              className='aspect-square rounded-full bg-gray-200 dark:bg-neutral-800 mr-8'
            >
